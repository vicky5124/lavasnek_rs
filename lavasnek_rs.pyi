...
class Node:
    ...
    is_paused: bool
    queue: list[TrackQueue]
    async def get_data(self): ...
    async def set_data(self, data: t.Union[t.Any, dict]): ...
...
class Lavalink:
    ...
    async def equalize_all(self, guild_id: int, bands: list[float]) -> None: ...
    async def equalize_dynamic(self, guild_id: int, bands) -> None: ...
    async def equalize_band(self, guild_id: int, band) -> None: ...
